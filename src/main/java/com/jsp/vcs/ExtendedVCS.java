...
public class ExtendedVCS
{
   ...
   public BufferedImage secretMsg;
   public BufferedImage[] innocentShares;
   //public int[2][] shareOrigRGBPixels;
   public int[][] encryptedShareRGB;
   
   public int numSharesToDecrypt;
   public BufferedImage[] sharesToDecrypt;
   public int[] secretMsgPixels;
   ...
   public void createPixelsOfShares(int[] secretImgRGB, int[][] shareOriginalRGB)
   {
