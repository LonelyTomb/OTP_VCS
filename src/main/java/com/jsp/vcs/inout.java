...
public class inout {
    ...
    public static int sharecnt = 0;
    public static Scanner read = new Scanner(System.in);
    public static int getCount(){
    return sharecnt-1;
    }
    public static void changeCnt(int number){
        sharecnt =number;
    }
//    public static void main(String args[]) throws IOException {
//        long startTime = System.currentTimeMillis();
//        BufferedImage img = loadImage("C:\\wamp\\www\\PVC\\ProgressiveVC\\text.jpg");
...
//    }
    ...
    public static boolean saveImage(BufferedImage pic, String filename, int format) {
        boolean valid = false;
    ...
    public static int[][][] makeShares(int[][] pixels, int Nshares,String filename) throws IOException {
        ...
        /* -----------------------------------------Shares---------------------------------------*/
        for (int i = 0; i < Nshares; i++) {
            getImageFromArray(Shares[i], width, height,filename);
        }
        return Shares;

    }

    public static void getImageFromArray(int[][] pixels, int width, int height,String filename) {
        ...
        pic.save(filename + sharecnt + ".jpg");
        //pic.show();
        sharecnt++;
    }
    ...
    public static void decrypt(int width, int height, int Nshares, int[][][] shares) {
        ...
        getImageFromArray(pic, width, height,"output");
    }
