...
public class alter {
  ...
  public static BufferedImage monochrome(BufferedImage picture) {
  ...
  public static BufferedImage meldImages(BufferedImage template, BufferedImage random) {
    int i,j;
  ...
  public static BufferedImage createRandom(BufferedImage template) {
    int i,j;
